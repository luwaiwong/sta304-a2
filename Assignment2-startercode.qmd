...
$$\bar{X} \pm \chi_{\alpha/2} \sqrt{\frac{\hat X(1-\hat X)}{n}}$$

Where:

-   $\hat X$ is the sample proportion of individuals who voted for the Liberal party.
-   $\chi_{\alpha/2}$​ is the critical value from the standard normal distribution corresponding to the desired confidence level (for a 95% confidence interval, $\chi_{\alpha/2}=1.96$).
-   $n$ is the sample size of the survey respondents with valid vote choice data.
-   $\sqrt{\frac{\hat X(1-\hat X)}{n}}$ is the standard error of the proportion of individuals who voted for the Liberal party
